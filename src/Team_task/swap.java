...
public class swap {
    public static void main(String[] args) {
        /*Write a program to Team_task.swap 2 numbers without using the 3rd (temporary) variable?*/
        ...
        // display Check_Six List before Team_task.swap
        ...
        Collections.swap(newOne, 1, 4);//if we wanna swap last one (number=size-1)

        // display Check_Six List after swap

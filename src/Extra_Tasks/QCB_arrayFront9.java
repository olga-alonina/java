...
public class QCB_arrayFront9 {
    /*Given an array of ints, return true if
    one of the first 4 elements in the array is a 9.
     The array length may be less than 4.
QCB_arrayFront9([1, 2, 9, 3, 4]) → true
QCB_arrayFront9([1, 2, 3, 4, 9]) → false
QCB_arrayFront9([1, 2, 3, 4, 5]) → false*/
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {9, 2, 3};
        int[] nums2 = {1, 2, 3, 4, 5};
       // System.out.println( QCB_arrayFront9( nums ) );
